...
export class ProductService {
    ...
    private createFilter(dto: GetAllProductDto): Prisma.ProductWhereInput {
        ...
        if (dto.minPrice || dto.maxPrice) filters.push(this.getPriceFilter(convertToNumber(dto.minPrice), convertToNumber(dto.maxPrice)))
    ...
    private getSortOption(sort: EnumbProductSort): Prisma.ProductOrderByWithRelationInput[] {
        switch(sort) {
            case EnumbProductSort.LOW_PRICE:
                return [{ price: 'asc' }]
            case EnumbProductSort.HIGH_PRICE:
                return [{ price: 'desc' }]
            case EnumbProductSort.OLDEST:
